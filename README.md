...
The documentation site is the primary way to read this material: 48 pages with
...
```bash
./tests/run_all.sh                  # 32 suites, no GPU and no downloads
...
│   └── 12_qlora/                # NF4 QLoRA vs bf16 LoRA: per-GPU memory under ZeRO-2
│
